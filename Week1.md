...
- Feelings Check-In
- Maybe Algorithms Study Group
- Maybe Creative Coding Group
...
- I've learned about [headless CMS](https://www.gatsbyjs.org/docs/headless-cms/) and static websites
- A bit of Python syntax and some ways it's different in from Javascript
- That I can build something in React from scratch on my own without following a tutorial
